        ...
        <div class="main">
            <div class="nav">
                <div class="header_nav">
                    ...
                    <p style="margin-left:15px;">adminTrungTâm</p>
                </div>
                <div class="menu">
                ...
                <div class="navbar">
                    <ul>
                        ...
                        <a href="http://localhost:8080/ThanhDoanTST/ttKH.php"><li><i class="fa fa-info-circle" aria-hidden="true"></i>Quản lý tin tức</li></a>
                    </ul>
                </div>
