...
<body>           
        <div class="main">
            <div class="nav">
                ...
                <div class="navbar">
                    <ul>
                        <a href="http://localhost:8080/webbandongho/admin.php"><li><i class="fa fa-suitcase" aria-hidden="true"></i>Quản lý trẻ em</li></a>
                        <a href="http://localhost:8080/webbandongho/QLngdung.php"><li><i class="fa fa-user" aria-hidden="true"></i>Quản lý nhà hỗ trợ</li></a>
                        <a href="http://localhost:8080/webbandongho/QLdonhang.php"><li><i class="fa fa-truck" aria-hidden="true"></i>Chi tiết hỗ trợ</li></a>
                        <a href="http://localhost:8080/webbandongho/ttKH.php"><li><i class="fa fa-info-circle" aria-hidden="true"></i>Quản lý tin tức</li></a>
                    </ul>
                </div>
            </div>
            <div class="content ">
                            ...
                            <div class="right_side_them">
                                <div class="form_group">
                                    <div class="">
                                        ...
                                        <label for="">Trình độ:</label></br>
                                        <input type="text" name="vatlieuvo" required></br>
                                        <label for="">Sức khỏe:</label></br>
